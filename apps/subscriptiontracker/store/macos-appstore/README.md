...
`apps/subscriptiontracker/macos/Runner/PrivacyInfo.xcprivacy` is **generated**, by
`tooling/store/render-apple-privacy-manifest.mjs`, from
`apps/subscriptiontracker/store/ios-appstore/privacy-manifest.json` — the **same** audit file that
