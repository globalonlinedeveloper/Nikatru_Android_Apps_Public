...
frame is released by the guarded shutter in `apps/subscriptiontracker/integration_test/store_capture_guard.dart`,
...
`node tooling/store/capture-play-screenshots.mjs --app subscriptiontracker` drives **both** viewports and writes
