...
| `support-url.txt` | Support contact info | `apps/subscriptiontracker/lib/core/app_config.dart` → `contactUrl` | ✅ exact match |
...
node tooling/release/submit-windows-store.mjs --dry-run --app subscriptiontracker
```
