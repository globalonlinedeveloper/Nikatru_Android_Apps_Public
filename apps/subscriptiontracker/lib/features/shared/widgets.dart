...
/// *"`apps/subscriptiontracker` ships as a frozen legacy rail-prover"*. It does not, and did
...
/// which is `apps/subscriptiontracker`'s and which no other app can see. Reading `AppConfig`
...
///   .mjs` scans the brick and `apps/subscriptiontracker/lib` (:119-131) and NOT `packages/`,
