...
/// `services/platform/src/app-config-data.json` serves `subscriptiontracker`
...
/// `apps.subscriptiontracker`), surfaced through `services/platform/src/config.ts`
...
/// `apps/subscriptiontracker/test/config_default_test.dart` by the marker string
