...
//     owns the ordering (precondition → platform_db → relay to subscriptiontracker-api →
...
//     `reminder-intent-persisted` property — a mapping `apps/subscriptiontracker` is exempt
