...
class AppConfig {
  ...
  static const String appId = 'subscriptiontracker';
  ...
  /// (`grep -rn appTagline apps/subscriptiontracker/{lib,test,integration_test}`). Kept
  ...
  static const String _phApiBase =
      'https://subscriptiontracker-api.YOUR_SUBDOMAIN.workers.dev';
