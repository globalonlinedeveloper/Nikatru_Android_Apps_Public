...
// `subscriptiontracker-e2e+1785856022717@nikatru.com` — an internal test address on a public
...
// `apps/subscriptiontracker/test/store_capture_guard_test.dart` drives both directions of
