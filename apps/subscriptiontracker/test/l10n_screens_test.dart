...
// know about:
//
//   1. `subscriptiontrackerOnboarding1Title` carries NO `\n` (WORKORDER §1). The Dart literal
//      it replaced did, and the hard break was placed for one English phrase.
//   2. `subscriptiontrackerOnboarding*` is a NEW family, not an overwrite of the chassis
  ...
  group('the routed onboarding carousel speaks both locales', () {
    ...
    test('the copy decisions this family encodes', () async {
      ...
      for (final String s in <String>[
        ...
        en.subscriptiontrackerOnboarding2Title,
        en.subscriptiontrackerOnboarding3Title,
