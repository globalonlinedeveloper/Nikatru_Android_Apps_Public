...
// so Flutter's NOTICES collector never sees it. `apps/subscriptiontracker/lib/main.dart` calls
...
//
// So before this file, deleting one line from `apps/subscriptiontracker/lib/main.dart` put the
...
// occurrence of the name in `apps/subscriptiontracker/lib/main.dart` is the live call on line
