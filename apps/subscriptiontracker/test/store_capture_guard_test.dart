...
// `subscriptiontracker-e2e+1785856022717@nikatru.com`. `assert-listing-assets.mjs` passed it:
...
// still a widget tree.
//
// Run:  flutter test test/store_capture_guard_test.dart   (from apps/subscriptiontracker)
// ─────────────────────────────────────────────────────────────────────────────
...
const String kE2EAddress = 'subscriptiontracker-e2e+1785856022717@nikatru.com';
