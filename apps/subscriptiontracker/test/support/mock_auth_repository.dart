...
import 'package:subscriptiontracker/data/auth/auth_repository.dart';
...
/// (`git show 255265b:apps/subscriptiontracker/lib/state/providers.dart:544`). The ONLY
...
class MockAuthRepository extends AuthRepository {
  ...
  ///
  /// 🔄 THE "apps/subscriptiontracker IS FROZEN (39-CHASSIS cut 1)" CLAUSE IS GONE FROM THIS
