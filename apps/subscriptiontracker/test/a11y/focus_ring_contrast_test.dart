...
// grounds `apps/subscriptiontracker` actually paints under a `FocusableTap` (the live
...
/// The seed `apps/subscriptiontracker/lib/app.dart` passes to BOTH `theme:` and `darkTheme:`.
///
...
/// Where the control sits. Both values are grounds `apps/subscriptiontracker` really paints
