...
- **Reasoning:** `Private/pre-minimal-2026-09-08:research/44-CROSS-PROMOTION-HOUSE-ADS-OFFERS.md` §3 V2 / V3 / V4 and §4.
...
Primary text, quoted in `Private/pre-minimal-2026-09-08:research/44-CROSS-PROMOTION-HOUSE-ADS-OFFERS.md` §3 with its citations:
