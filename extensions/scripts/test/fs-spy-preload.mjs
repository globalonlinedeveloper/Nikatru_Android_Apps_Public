// COPY of tooling/ci/test/fixtures/fs-spy-preload.mjs, kept here because extensions/ is self-contained
// (shared code is copied, not linked). Change the two together.
// ─────────────────────────────────────────────────────────────────────────────
