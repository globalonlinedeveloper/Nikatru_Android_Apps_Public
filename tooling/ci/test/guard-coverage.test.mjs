...
describe('assert-guard-coverage', () => {
  ...
  // ── [pipeline S-12r] executables OUTSIDE tooling/ci that a workflow runs ─── (absent from origins.lock.json by construction — S-12r is a residual of S-12, raised by Private/pre-minimal-2026-09-08:plans/03-stamper-plan.md after the pipeline harvest was frozen)
