...
// ── 3 · [pipeline S-1r] NO PRINTED STEP MAY BE ONE A LOCKED ADR RETIRED ───── (absent from origins.lock.json by construction — S-1r is a residual of S-1, raised by Private/pre-minimal-2026-09-08:plans/03-stamper-plan.md after the pipeline harvest was frozen)
